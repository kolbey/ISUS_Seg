...
from geoseg.datasets.flair_kfold_dataset import *
...
weights_name = "FT-JLoss-H_V_RR_O-Epoch40-RGB-IMS-K5_5"
weights_path = "model_weights/flair2/{}".format(weights_name)
test_weights_name = "FT-JLoss-H_V_RR_O-Epoch40-RGB-IMS-K5_5"
...
train_dataset = FLAIRKTrainDataset(mode='train')

val_dataset = FLAIRKTrainDataset(mode='val')

test_dataset = FLAIRKTestDataset(mode='test')
