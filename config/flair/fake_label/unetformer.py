...
weights_name = "UN-Epoch30-FakeLabel-Epoch15-NRG-IMS"
weights_path = "model_weights/flair2/{}".format(weights_name)
test_weights_name = "UN-Epoch30-FakeLabel-Epoch15-NRG-IMS"
...
gpus = [1]
strategy = None
pretrained_ckpt_path = 'model_weights/flair2/UN-UFLoss-H_V_RR-Epoch30-NRG-IMS/UN-UFLoss-H_V_RR-Epoch30-NRG-IMS.ckpt'
...
# loss = UFLossV1(ignore_index=ignore_index)
use_aux_loss = True
