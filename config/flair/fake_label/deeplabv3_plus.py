...
weights_name = "DL-Epoch30-FakeLabel-Epoch15-NRG-IMS"
weights_path = "model_weights/flair2/{}".format(weights_name)
test_weights_name = "DL-Epoch30-FakeLabel-Epoch15-NRG-IMS"
...
gpus = [0]
strategy = None
pretrained_ckpt_path = 'model_weights/flair2/DL-EdgeLoss-H_V_RR-Epoch30-NRG-IMS/DL-EdgeLoss-H_V_RR-Epoch30-NRG-IMS.ckpt'
