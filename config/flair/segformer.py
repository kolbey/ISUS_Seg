...
weights_name = "SE3-EdgeLoss-H_V_RR-Epoch50"
weights_path = "model_weights/flair2/{}".format(weights_name)
test_weights_name = "SE3-EdgeLoss-H_V_RR-Epoch50"
...
resume_ckpt_path = 'model_weights/flair2/SE3-EdgeLoss-H_V_RR-Epoch30/SE3-EdgeLoss-H_V_RR-Epoch30.ckpt'
#  define the network
