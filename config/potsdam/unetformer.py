...
test_time_aug = 'd4'
output_mask_dir, output_mask_rgb_dir = './fig_results/masks/', './fig_results/masks_rgb/'
...
train_dataset = PotsdamDataset(data_root='../Dataset/Potsdam/train', mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(transform=val_aug)
test_dataset = PotsdamDataset(data_root='../Dataset/Potsdam/test',
                              transform=val_aug)
