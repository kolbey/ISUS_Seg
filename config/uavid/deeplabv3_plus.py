...
weights_name = "DL-EdgeLoss-MS-Epoch60"
...
train_dataset = UAVIDDataset(data_root='../uavid/train', img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='../uavid/val', img_dir='images', mask_dir='masks', mode='val',
