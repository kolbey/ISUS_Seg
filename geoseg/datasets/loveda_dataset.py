...
loveda_val_dataset = LoveDATrainDataset(data_root='../DATASET/Original_LoveDA/val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='../DATASET/Original_LoveDA/test', img_dir='images_png',
