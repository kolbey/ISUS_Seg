...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="data/AerialImageDataset/train/train_images")
    parser.add_argument("--input-mask-dir", default="data/AerialImageDataset/train/train_masks")
    parser.add_argument("--output-img-dir", default="data/AerialImageDataset/train/train/images")
    parser.add_argument("--output-mask-dir", default="data/AerialImageDataset/train/train/masks")
